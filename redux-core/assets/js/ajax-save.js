...
(function ($) {
  ...
  $.redux.ajax_save = function (button) {
    ...
    overlay.fadeIn(); // Add the loading mechanism.
    ...
    $data = $parent.serialize(); // Add values for checked and unchecked checkboxes fields.
...
(function ($) {
  ...
  $.redux.initEvents = function (el) {
    ...
    el.find('#customize-save-button-wrapper #save').on('click', function () {});
    el.find('#toplevel_page_' + redux.optName.args.slug + ' .wp-submenu a, #wp-admin-bar-' + redux.optName.args.slug + ' a.ab-item').click(function (e) {
      var url;
    ...
    el.find('.redux-action_bar input, #redux-import-action input').on('click', function (e) {
    ...
    $(document.body).on('change', '.redux-field input, .redux-field textarea, .redux-field select', function () {
...
(function ($) {
  ...
  $.redux.initFields = function () {
    $('.redux-group-tab:visible').find('.redux-field-init:visible').each(function () {
      var tr;
      var th;
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $('fieldset.redux-container-divide').css('display', 'none'); // Weed out multiple instances of duplicate Redux instance.
  ...
  $.redux.getOptName = function (el) {
    ...
    if (undefined === optName) {
      ...
      if (0 !== metabox.length) {
        ...
        if (undefined === optName) {
          optName = metabox.attr('class').replace('redux-metabox', '').replace('postbox', '').replace('redux-', '').replace('hide', '').replace('closed', '').trim();
        }
      } else {
...
(function ($) {
  ...
  $.redux.sanitize = function () {
    if (redux.optName.sanitize && redux.optName.sanitize.sanitize) {
      $.each(redux.optName.sanitize.sanitize, function (sectionID, sectionArray) {
        sectionID = null;
  ...
  $.redux.notices = function () {
    if (redux.optName.errors && redux.optName.errors.errors) {
      $.each(redux.optName.errors.errors, function (sectionID, sectionArray) {
        sectionID = null;
      ...
      $('.redux-container').each(function () {
        var totalErrors;
        var container = $(this); // Ajax cleanup.
    ...
    if (redux.optName.warnings && redux.optName.warnings.warnings) {
      $.each(redux.optName.warnings.warnings, function (sectionID, sectionArray) {
        sectionID = null;
...
(function ($) {
  ...
  $.redux.initQtip = function () {
    ...
    var shadow = '';
    var tipShadow = redux.optName.args.hints.tip_style.shadow; // Color.

    var color = '';
    var tipColor = redux.optName.args.hints.tip_style.color; // Rounded.

    var rounded = '';
    var tipRounded = redux.optName.args.hints.tip_style.rounded; // Tip style.

    var style = '';
    var tipStyle = redux.optName.args.hints.tip_style.style; // Get position data.

    var myPos = redux.optName.args.hints.tip_position.my;
    var atPos = redux.optName.args.hints.tip_position.at; // Tooltip trigger action.

    var showEvent = redux.optName.args.hints.tip_effect.show.event;
    var hideEvent = redux.optName.args.hints.tip_effect.hide.event; // Tip show effect.

    var tipShowEffect = redux.optName.args.hints.tip_effect.show.effect;
    var tipShowDuration = redux.optName.args.hints.tip_effect.show.duration; // Tip hide effect.
    ...
    if ($().qtip) {
      ...
      classes = classes.replace(/,/g, ' '); // Gotta be lowercase, and in proper format.
  ...
  $.redux.verifyPos = function (s, b) {
    var split;
    var paramOne;
    var paramTwo; // Trim off spaces.

    s = s.replace(/^\s+|\s+$/gm, ''); // Position value is blank, set the default.
    ...
    split = s.split(' '); // Evaluate first string.  Must be top, center, or bottom.
...
var confirmOnPageExit = function confirmOnPageExit(e) {
  ...
  var message;
  e = e || window.event;
  message = redux.optName.args.save_pending; // For IE6-8 and Firefox prior to version 4.

  if (e) {
    e.returnValue = message;
  }

  window.onbeforeunload = null; // For Chrome, Safari, IE8+ and Opera 12+.
...
function redux_change(variable) {
  ...
  (function ($) {
    ...
    parentID = $(variable).closest('.redux-group-tab').attr('id'); // Let's count down the errors now. Fancy.  ;).
...
(function ($) {
  ...
  $.redux.checkRequired = function (el) {
    $.redux.required();
    $('body').on('change', '.redux-main select, .redux-main radio, .redux-main input[type=checkbox], .redux-main input[type=hidden]', function () {
  ...
  $.redux.required = function () {
    ...
    $.each(redux.opt_names, function (x) {
      $.each(window['redux_' + redux.opt_names[x].replace(/\-/g, '_')].folds, function (i, v) {
        var div;
        var rawTable;
  ...
  $.redux.getContainerValue = function (id) {
    ...
    if (null !== value && 'object' === _typeof(value) && value.hasOwnProperty(redux.optName.args.opt_name)) {
...
(function ($) {
  ...
  $.redux.tabCheck = function () {
    ...
    $('.redux-group-tab-link-a').click(function () {
      ...
      el.find('#toplevel_page_' + redux.optName.args.slug + ' .wp-submenu a').each(function () {
      ...
      if (el.find('#' + oldid + '_section_group_li').find('#' + oldid + '_section_group_li').length) {
        ...
        if (el.find('#' + oldid + '_section_group_li').find('ul.subsection').length) {
          el.find('#' + oldid + '_section_group_li').find('ul.subsection').slideUp('fast', function () {
          ...
          if (!el.find('#' + oldid + '_section_group_li').parents('#' + relid + '_section_group_li').length) {
            el.find('#' + oldid + '_section_group_li').parents('ul.subsection').slideUp('fast', function () {
              el.find('#' + oldid + '_section_group_li').removeClass('active');
    ...
    if ('' !== tab) {
      if ($.cookie('redux_current_tab_get') !== tab) {
        ...
        $.cookie('redux_current_tab_' + redux.optName.args.opt_name, tab, {
          expires: 7,
          path: '/'
        });
...
/***/ 45:
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./redux-core/assets/js/redux/ajax-save.js ./redux-core/assets/js/redux/color-validate.js ./redux-core/assets/js/redux/expand-options.js ./redux-core/assets/js/redux/init-events.js ./redux-core/assets/js/redux/init-fields.js ./redux-core/assets/js/redux/main.js ./redux-core/assets/js/redux/notices.js ./redux-core/assets/js/redux/qtip.js ./redux-core/assets/js/redux/redux-change.js ./redux-core/assets/js/redux/redux-hook.js ./redux-core/assets/js/redux/required.js ./redux-core/assets/js/redux/sticky-info.js ./redux-core/assets/js/redux/tab-check.js ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\ajax-save.js */"./redux-core/assets/js/redux/ajax-save.js");
__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\color-validate.js */"./redux-core/assets/js/redux/color-validate.js");
__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\expand-options.js */"./redux-core/assets/js/redux/expand-options.js");
__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\init-events.js */"./redux-core/assets/js/redux/init-events.js");
__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\init-fields.js */"./redux-core/assets/js/redux/init-fields.js");
__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\main.js */"./redux-core/assets/js/redux/main.js");
__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\notices.js */"./redux-core/assets/js/redux/notices.js");
__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\qtip.js */"./redux-core/assets/js/redux/qtip.js");
__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\redux-change.js */"./redux-core/assets/js/redux/redux-change.js");
__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\redux-hook.js */"./redux-core/assets/js/redux/redux-hook.js");
__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\required.js */"./redux-core/assets/js/redux/required.js");
__webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\sticky-info.js */"./redux-core/assets/js/redux/sticky-info.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\wordpress\wp-content\plugins\redux-framework-4\redux-core\assets\js\redux\tab-check.js */"./redux-core/assets/js/redux/tab-check.js");
